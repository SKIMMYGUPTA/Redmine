...
New to Redmine? Register yourself here ⬇️ [https://kore.koders.in/ ](https://kore.koders.in/) 
...
On the top left corner, “PROJECT” lets you select the Project from the available options that you want to create. 

Helps you create New Projects and lets you update the details about the same. 
...
[didn’t have the access] **MEMBERS:** 
...
STATUS: shows the status of the issue (new, in progress, resolved or closed). PRIORITY: shows the importance of the issue. 
