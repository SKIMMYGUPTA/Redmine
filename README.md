...
**Redmine**, a web-based application used by Koders is project management and issue tracking tool that allows users to manage multiple projects with features like wikis, forums, and time–tracking role-based access control. 
...
- Features Gantt Chart and Calendar. 
...
[https://kore.koders.in/

![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.001.jpeg)

### **🗝️LOGIN**


Once approved, by one our admins you’ll be able to login with the given **NAME** and **PASSWORD**.
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.002.png)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.003.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.004.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.005.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.006.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.007.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.009.jpeg)
### **⏳SPENT TIME** 

Allows you to keep track of the log hours on a particular issue or project. **LOG TIME⏲️** 

![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.010.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.011.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.012.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.013.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.014.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.015.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.016.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.017.jpeg)
##### **💹CUMULATIVE FLOW** 
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.018.jpeg)

##### **📊VELOCITY** 

The chart shows how many issues were created and closed over time. 
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.019.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.020.jpeg)

##### **🔁CYCLE TIME** 

It shows an average and total time spent to finish each task for each issue type over a selected timeline.  
 
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.021.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.022.jpeg)
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.023.jpeg)
...
[didn’t have the access] ##### **📊VERSIONS** 
...
◼️ **Name**: The text you want to display for identifying the version. 
◼️ **Description**: A short description of the displayed version.  
◼️ **Status**: the status lets you control how issues can be assigned in version.
   **🔸open**: no restriction (default) 
   **🔸locked**: cannot assign new issues to the version 
   **🔸closed**: cannot reopen assigned issues 
◼️ **Wiki Page**: The name of page assigned to the version.  
◼️  **Due date**: The deadline of the version to be completed.  
◼️ **Sharing**: Lets you share the version with other projects. Each version can be shared with: 
...
◼️ Sharing a version of a private project with public projects will make its name visible to everyone. 
◼️ From the versions list, you can click on **Close Completed Versions** to automatically set the status of all the completed versions to **closed**. 
##### **🟡ISSUE CATEGORIES** 
...
![](./assets/Aspose.Words.13e42bd3-9cb4-4e9d-b0cc-d96f348ded92.024.jpeg)
